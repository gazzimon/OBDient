// OBDient harvest seed peer (PLAN-002 v2, C3).
//
// Runs on a PC/VPS — plain Node, no server framework. Joins the harvest DHT
// topic as SERVER only, replicates contributor feeds READ-ONLY, and persists
// them under ./data so `harvest.mjs` can export corrections.jsonl offline.
//
...
// briefs, no VIN / BT address / identity (contract: ADR-0002/0003).
//
// Usage:  node tools/seed-peer/index.mjs [--data <dir>]
